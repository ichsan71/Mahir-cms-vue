...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "pengaturan-cuti", name: "pengaturan-cuti", component: () => import("@/features/leaveRules/views/LeaveManagementView.vue"), meta: { title: "Pengaturan Cuti", permission: ["listLeaveRule", "listLeaveType"] } },
      ...
      { path: "kehadiran", name: "kehadiran", component: () => import("@/features/attendance/views/AttendanceView.vue"), meta: { title: "Monitoring Kehadiran", soon: true, permission: "attendanceRecords" } },
      { path: "cuti", name: "cuti", component: () => import("@/features/leaveApprovals/views/LeaveTransactionView.vue"), meta: { title: "Cuti & Izin", permission: ["listLeave", "listLeaveApproval", "listLeaveBalance", "listLeaveBalanceTransaction", "listLeaveMandatoryApprover"] } },
