...
// query. Nilai baru di-commit ke store setelah jeda (debounce).
...
// Sinkron balik bila store di-reset dari luar.
watch(
  () => filters.search,
  (s) => {
...
<template>
  <div class="flex flex-wrap items-center gap-2">
    ...
    <button
      ...
      @click="emit('add')"
    >
      <PlusIcon class="h-4 w-4" /> Tambah Perusahaan
    </button>
  </div>
</template>
