<script setup>
// Halaman gabungan: Shift & Pola Kerja dalam satu menu (dua tab) karena saling
// berhubungan. Tab aktif disinkron ke query `?tab` agar bisa dibagikan & kembali
// dari halaman detail ke tab yang benar.
import { computed, watch } from "vue";
import { useRoute, useRouter } from "vue-router";
import { useAuthStore } from "@/features/auth/stores/auth.store";
import ShiftsView from "./ShiftsView.vue";
import WorkPatternsView from "@/features/workPatterns/views/WorkPatternsView.vue";
...
<template>
  ...
  <div class="mb-5">
    ...
    <p class="text-sm text-mahir-muted">Kelola shift kerja dan pola jadwal mingguan Mazta Group</p>
  </div>
  ...
  <!-- Konten tab aktif -->
  <ShiftsView v-if="activeTab === 'shift'" />
  <WorkPatternsView v-else-if="activeTab === 'pola-kerja'" />
</template>
